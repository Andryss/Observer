...
public class AddCommand implements ConfigCommand {

    private final TransactionTemplate transactionTemplate;
    private final ConfigService configService;

    @Getter
    private final ConfigCommandInfo configCommandInfo = new ConfigCommandInfo("add");
    ...
    public void execute(List<String> arguments, Update update, AbsSender sender) throws Exception {
        ...
        if (arguments.size() < 2) {
            throw new IllegalArgumentException("No value to add argument");
        }
