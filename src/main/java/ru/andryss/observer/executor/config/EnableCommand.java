...
public class EnableCommand implements ConfigCommand {

    private final ConfigService configService;

    @Getter
    private final ConfigCommandInfo configCommandInfo = new ConfigCommandInfo("enable");
    ...
    public void execute(List<String> arguments, Update update, AbsSender sender) throws Exception {
        ...
        configService.putBoolean(configKey, true);
